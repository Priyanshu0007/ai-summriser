  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        ...
        <p className="font-inter font-bold text-black text-center">Well,that wans`t supposed to happen<br/>
        <span className="font-satoshi font-normal">
          {error?.data?.error}
          </span></p>):(article.summary&&(
          <div className="flex flex-col gap-3">
            <h2 className="font-satoshi font-bold text-gray-600">Article<span className="blue-gradient">Summary</span></h2>
